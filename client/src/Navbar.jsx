...
const Navbar = () => {
  ...
  return (
    <nav className="bg-slate-800 mb-8">
      <div className="flex flex-wrap items-center justify-center lg:justify-between mx-auto p-4 mb-3 lg:ml-10">
        <a href="/" className="flex items-center">
          <IoCarSport size={32} className="mr-3 text-green-600" />
